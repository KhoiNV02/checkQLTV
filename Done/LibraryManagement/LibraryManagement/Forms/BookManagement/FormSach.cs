...
namespace FormSach
{
    public partial class Form1 : Form
    {
        ...
        public SqlConnection myConnection; // kết nối tới csdl
        public SqlDataAdapter myDataAdapter;   // Vận chuyển csdl qa DataSet
        public DataTable myTable;  // Dùng để lưu bảng lấy từ c#
        SqlCommand myCommand;   // Thực hiện cách lệnh truy vấn
        public Form1()
        {
            InitializeComponent();
        }
        public DataTable ketnoi(string truyvan)
        {
        ...
        public void ketnoiNonQuery(string nonquery)
        {
            myConnection = new SqlConnection(chuoiKetNoi);
            myConnection.Open();
        ...
        public void cbMaDS_SelectedValueChanged(object sender, EventArgs e)
        {
        ...
        public void cbTenSach_SelectedValueChanged(object sender, EventArgs e)
        {
        ...
        public void txbTenTG_KeyPress(object sender, KeyPressEventArgs e)
        {
            e.Handled = true;
        }

        public void txbMaSach_KeyPress(object sender, KeyPressEventArgs e)
        {
            e.Handled = true;
        }

        public void txbSoLuongTon_KeyPress(object sender, KeyPressEventArgs e)
        {
            e.Handled = true;
        }

        public void txbGiaTien_KeyPress(object sender, KeyPressEventArgs e)
        {
